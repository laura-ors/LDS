...
**GitHub Actions** — это встроенная платформа для автоматизации процессов [[CI CD|CI/CD]] прямо внутри GitHub.
...
- **[[GitLab CI CD|GitLab CI/CD]]** — "встроенный конвейер" внутри фабрики GitLab  
